...
type AuthServiceClient interface {
	...
	RevokeToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*status.Status, error)
...
func (c *authServiceClient) RevokeToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*status.Status, error) {
...
type AuthServiceServer interface {
	...
	RevokeToken(context.Context, *TokenRequest) (*status.Status, error)
...
func (UnimplementedAuthServiceServer) RevokeToken(context.Context, *TokenRequest) (*status.Status, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method RevokeToken not implemented")
}
func (UnimplementedAuthServiceServer) RefreshToken(context.Context, *TokenRequest) (*TokenResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method RefreshToken not implemented")
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/v1/auth/auth.proto",
}
